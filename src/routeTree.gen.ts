...
const HistoriaDasEnchentesPelotasRoute = HistoriaDasEnchentesPelotasRouteImport.update({
...
const NivelDaLagoaDosPatosRoute = NivelDaLagoaDosPatosRouteImport.update({
