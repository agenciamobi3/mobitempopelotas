...
export const REGIONAL_CITIES: RegionalCity[] = [
  ...
  { slug: "arambare-rs", name: "Arambaré", state: "RS", ibgeCode: "4300851", latitude: -30.91464, longitude: -51.50059, group: "Costa Doce", descriptor: "município balneário da Costa Doce na margem oeste da Lagoa dos Patos", coverage: "basic", indexable: false },
  { slug: "barra-do-ribeiro-rs", name: "Barra do Ribeiro", state: "RS", ibgeCode: "4301909", latitude: -30.291, longitude: -51.301, group: "Costa Doce", descriptor: "município da Costa Doce na margem oeste do Guaíba", coverage: "basic", indexable: false },
  { slug: "camaqua-rs", name: "Camaquã", state: "RS", ibgeCode: "4303509", latitude: -30.85103, longitude: -51.81257, group: "Costa Doce", descriptor: "polo regional da Costa Doce próximo ao rio Camaquã", coverage: "basic", indexable: false },
  { slug: "cerro-grande-do-sul-rs", name: "Cerro Grande do Sul", state: "RS", ibgeCode: "4305173", latitude: -30.6, longitude: -51.75, group: "Costa Doce", descriptor: "município rural da Costa Doce na bacia do Camaquã", coverage: "basic", indexable: false },
  { slug: "dom-feliciano-rs", name: "Dom Feliciano", state: "RS", ibgeCode: "4306502", latitude: -30.70444, longitude: -52.11, group: "Costa Doce", descriptor: "município rural da bacia hidrográfica do rio Camaquã", coverage: "basic", indexable: false },
  { slug: "guaiba-rs", name: "Guaíba", state: "RS", ibgeCode: "4309308", latitude: -30.11055, longitude: -51.31756, group: "Costa Doce", descriptor: "cidade da Costa Doce na margem oeste do Guaíba", coverage: "basic", indexable: false },
  { slug: "mariana-pimentel-rs", name: "Mariana Pimentel", state: "RS", ibgeCode: "4311981", latitude: -30.35455, longitude: -51.58146, group: "Costa Doce", descriptor: "município rural entre a região do Guaíba e a Serra do Sudeste", coverage: "basic", indexable: false },
  { slug: "mostardas-rs", name: "Mostardas", state: "RS", ibgeCode: "4312500", latitude: -31.10467, longitude: -50.92183, group: "Costa Doce", descriptor: "município costeiro entre a Lagoa dos Patos e o oceano Atlântico", coverage: "basic", indexable: false },
  { slug: "sertao-santana-rs", name: "Sertão Santana", state: "RS", ibgeCode: "4320552", latitude: -30.45927, longitude: -51.60368, group: "Costa Doce", descriptor: "município rural da Costa Doce na transição para a região do Guaíba", coverage: "basic", indexable: false },
  { slug: "tapes-rs", name: "Tapes", state: "RS", ibgeCode: "4321105", latitude: -30.673, longitude: -51.396, group: "Costa Doce", descriptor: "cidade da Costa Doce na margem oeste da Lagoa dos Patos", coverage: "basic", indexable: false },
  { slug: "tavares-rs", name: "Tavares", state: "RS", ibgeCode: "4321352", latitude: -31.28769, longitude: -51.08923, group: "Costa Doce", descriptor: "município costeiro entre a Lagoa dos Patos, a Lagoa do Peixe e o oceano Atlântico", coverage: "basic", indexable: false },
