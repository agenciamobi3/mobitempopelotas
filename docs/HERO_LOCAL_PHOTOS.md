...
- nublado à noite e na madrugada: usa `pelotas-noite-madrugada-nublado.png` entre 19h e 06h59;
- nublado no entorno do meio-dia: `pelotas-meio-dia-nublado.png` entre 11h e 14h59;
- nublado nos demais horários diurnos: mantém o registro-base anterior.
...
Os registros locais entram de acordo com o próprio estado e o período que representam:
...
- `pelotas-noite-madrugada-nublado.png`, adicionado no commit `390939f15d04682671da1aca699f494406a28d8b`, é usado quando a condição resolvida é `cloud` entre 19h e 06h59;
...
O `kind` permanece `cloudy` quando a fotografia noturna é usada. A troca é apenas visual e contextual: céu nublado continua sendo céu nublado, mas sem exibir uma fotografia diurna às 03h30, 21h ou em outro horário noturno compatível.
...
Para `partly-cloudy-night`, a fotografia `pelotas-madrugada-parcialmente-nublado.png` entra apenas durante a madrugada, entre 00h e 06h59, também nos slots pares. Nos demais horários noturnos, e nos slots ímpares da madrugada, permanece `pelotas-parcialmente-nublado.avif` como comportamento anterior. Isso continua separado do novo registro `pelotas-noite-madrugada-nublado.png`, que representa `cloud` / céu nublado, não `partly-cloudy-night`.
