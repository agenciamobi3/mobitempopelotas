...
const OPTIONAL_APP_SHELL_URLS = [
  ...
  "/brand/tempo-pelotas-favicon-2026.png",
...
self.addEventListener("push", (event) => {
  ...
  const options = {
    ...
    icon: data.icon || "/brand/tempo-pelotas-favicon-2026.png",
    badge: data.badge || "/brand/tempo-pelotas-favicon-2026.png",
